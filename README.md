...
Оглавление в оферте и политике сделано двумя слоями: поверх нарисованного в
макете списка лежат прозрачные ссылки, а в левом нижнем углу висит плавающая
панель со всеми разделами. Цели прокрутки расставлены в процентах от высоты
документа, поэтому переживают любое масштабирование.
